# This script was writen by Secret Firefox.
# It facilitates a KDE Plasma post-install on Void Linux.
# After running the script, you should have a functional system with the Plasma desktop.
# Enjoy!
...
sudo xbps-install xdg-desktop-portal xdg-desktop-portal-gnome xdg-user-dirs xdg-user-dirs-gtk xdg-utils -y
...
# Install KDE Plasma and base applications

sudo xbps-install kde5 kde5-baseapps

# Install default Plasma applications
